...
file=pathlib.Path('BackendDataEntry.xlsx')
if file.exists():
    pass
else:
    file=Workbook()
    ...
    file.save('BackendDataEntry.xlsx')
...
def submit():
    ...
    file=openpyxl.load_workbook('BackendDataEntry.xlsx')
    sheet=file.active
    ...
    file.save(r'BackendDataEntry.xlsx')
...
#icon
icon_image=PhotoImage(file="F:\Screenshot_2019-04-09-22-22-08-1.png")
root.iconphoto(False,icon_image)

#heading
Label(root,text="Please fill this entry form:",font="arial 13", bg="#326273", fg="#fff").place(x=20,y=20)
